...
CREATE TABLE `achat_immo` (
  ...
  `quantite_achete_immo` int DEFAULT NULL,
  `prix_unitaire_immo` int DEFAULT NULL,
  `valeur_achat_immo` int DEFAULT NULL,
...
insert  into `achat_immo`(id_achat_immo,quantite_achete_immo,prix_unitaire_immo,valeur_achat_immo,date_achat_immo,id_immo,id_fournisseur,facture) values (1,2,2000,4000,'2025-04-25',1,1,'555'),(2,2,1000,2000,'2025-04-25',2,1,'444');
...
insert  into `article`(id_article,nom_article,description_article,quantite_en_stock,id_categorie) values (10,'fsdq','tsy aiko ty hoe inona fa de nosoratsoratako fotsiny tany no sady soratra tsy misy dikany akory',24,1),(8,'papier A4','Ram A4',10,2),(11,'imprimante','Machine',32,1);
...
CREATE TABLE `immobilisation` (
  ...
  `quantite_en_stock_immo` int DEFAULT NULL,
...
insert  into `immobilisation`(id_immo,nom_immo,description_immo,quantite_en_stock_immo,id_categorie_immo) values (1,'Ordinateur','Ordinateur de bureau',2,1),(2,'imprimante','rien',2,1);
...
CREATE TABLE `sortie_immo` (
  ...
  `quantite_sortie_immo` int DEFAULT NULL,
  `prix_unitaire_immo` int DEFAULT NULL,
  `valeur_sortie_immo` int DEFAULT NULL,
